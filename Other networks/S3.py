# -*- coding: utf-8 -*-
"""
Created on Thu May 24 10:30:32 2018
...
W_conv3 = tf.Variable(tf.truncated_normal(shape=[3,3,40,60], stddev=0.1), name = 'W_conv3')
b_conv3 = tf.Variable(tf.constant(0.1, shape=[60]), name = 'b_conv3')
...
## flatten layer
x_flat = tf.reshape(a_pool3, [-1,540])                              #outsize = batch*540

## fully connected layer 1
W_fc1 = tf.Variable(tf.truncated_normal(shape=[540,120], stddev=0.1), name = 'W_fc1')
