...
with tf.Session() as sess:
    ...
    for k in range(2221):
        ...
        cache_LM22[(k*2):(k*2+2),:] = a_fc2.eval(feed_dict = {x:test_xbatch, keep_prob:1})

print(cache_LM22)
## save the predicted keypoints to excel
cache_LM22_df = pd.DataFrame(cache_LM22)
writer = pd.ExcelWriter('LM22.xlsx')
cache_LM22_df.to_excel(writer,'sheet1')
writer.save()
