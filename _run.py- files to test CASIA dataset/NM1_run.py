...
for i in range(4442):
    ...
    #I choose the coordinate of left_top corner as (30,56) and right_bottom corner as (118,126)
    #at first crop a square region for test, width is 88 and height is 70 (approximately 31:39)
    #that is faceboundingbox = [30,56,118,126]
